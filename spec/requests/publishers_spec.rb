...
RSpec.describe PublishersController, type: :request do
  let(:publisher_1) { create :publisher, :with_p_book, name: 'MacMilla' }
  ...
  describe 'GET /api/publishers' do
    ...
    describe 'pagination' do
      context 'when asking for the first page' do
        before { get '/api/publishers?page1&per=2' }
    ...
    describe 'filtering' do
      context "with valid filtering param 'q[name_cont]'" do
        it "receives 'MacMilla' publisher back" do
          get "/api/publishers?q[name_cont]=MacMilla"
      ...
      context "with invalid filtering param 'q[fname_cont]'" do
        before { get '/api/publishers?q[fname_cont]=MacMilla' }
  ...
  describe 'GET /api/publishers/:id' do
    context 'with existing resource' do
      before { get "/api/publishers/#{publisher_1.id}" }
    ...
    context 'with nonexistent resource' do
      before { get "/api/publishers/89898989" }
  ...
  describe 'PATCH /api/publishers/:id' do
    before { patch "/api/publishers/#{publisher_1.id}", params: { data: params } }
    context 'with valid params' do
  ...
  describe 'DELETE /api/publishers/:id' do
    context 'with existing resource' do
      ...
      before { delete "/api/publishers/#{publisher.id}" }
